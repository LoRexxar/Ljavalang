...
| # | Issue | 描述 | 决策 | Commit |
|---|-------|------|------|--------|
| 1 | #41/#26/#114 | 一元运算符 prefix/postfix 保留 | ✅ 已实现 | 864cd63 |
| 2 | #133 | Visitor 类 | ✅ 已实现 (visitor.py) | 864cd63 |
| 3 | #88 | Receiver parameter | ✅ 已实现 | 864cd63 |
| 4 | #100 | Position.range 字段 | ✅ 已实现 | 864cd63 |
| 5 | #137 | Tokenizer return_index 参数 | ✅ 已实现 | 864cd63 |
| 6 | #51 | Tokenization 错误忽略选项 | ❌ 拒绝 | 掩盖错误不利调试 |
| 7 | #60 | 代码块行数 | ✅ 已解决 | end_position 支持 |
| 8 | #86 | Token 流还原代码 | ❌ 拒绝 | 超出解析器职责 |
| 9 | #97 | 大测试集变更 | ⬜ 后续评估 | 改动量巨大，需独立规划 |
